...
const UserDashboard = () => {
  ...
  const handleUploadAndContinue = async () => {
    ...
    try {
      ...
      // Show success message with rows/columns
      setSuccess(
        `Success! File uploaded. Rows: ${res.data.rows}, Columns: ${res.data.columns}`
      );
      // Optionally, redirect or update state for mapping
      navigate('/data-mapping', { state: { 
